...
export const electric = {
  ...
  p2: "The areas of specialization include Communication Systems, Semiconductor Electronics, Control & Guidance, Applied Electronics, VLSI Design. Our Mission is to educate students from all over India, including those from the local and rural areas, so that they become enlightened individuals, improving the living standards of their families, industry and society. We provide individual attention and world class quality of education. The EEE Department has been organizing industrial visits, guest lectures and the IEEE Chapter. The Department has well equipped facilities like Standard labs and a Seminar hall.",
