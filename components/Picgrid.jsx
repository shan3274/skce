...
const BlurImage = ({ card }) => {
  ...
  return (
    <img
      ...
      className={cn(
        "object-cover object-top absolute w-full inset-0  h-full transition duration-200 "
      )}
      alt="thumbnail"
    />
    // <Image
    ...
    //   onLoad={() => setLoaded(true)}
    //   className={cn(
    //     "object-cover object-top absolute w-[500px] inset-0  h-[500px] transition duration-200 "
    //   )}
    //   alt="thumbnail"
    // />
  );
