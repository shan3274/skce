...
const Layout2 = ({ data }) => {
  ...
  return (
    <motion.div className="w-full min-h-screen  flex flex-col gap-5 items-center justify-center py-10">
      <motion.div className="lg:w-[80%] w-full min-h-[70vh] flex items-center justify-around">
        <div className="w-[30%] min-h-[20%]  drop-shadow-lg p-10">
          ...
          {data?.systemconfig?.data?.map((item, key) => {
            return (
              ...
              >
                <p className="font-sans text-[15px]">{item.title}</p>
                <p className="font-serif   text-[10px]">{item.description}</p>
              </motion.div>
            );
          })}
        </div>
      ...
      <motion.div className="lg:w-[80%] min-h-[70vh] flex items-center justify-around">
        <motion.img
      ...
      <div className="w-[80%] min-h-[70vh] flex items-center justify-around">
        <div className="w-[30%] min-h-[20%] max-h-[70vh] overflow-hidden flex-wrap  drop-shadow-lg p-10">
