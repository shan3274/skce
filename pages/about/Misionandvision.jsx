...
const Misionandvision = () => {
  const data = {
    ...
    bg: "https://images.unsplash.com/photo-1581092917372-d2db8f7904c6?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  };
  return (
    <div>
      <Layout3 data={data} />
